	...
	L.drawVersion = "1.0.4", L.Draw = {}, L.drawLocal = {
			...
			draw: {
				...
				handlers: {
					...
					polyline: {
						error: "<strong>Error:</strong> 图形边不支持相交!",
						tooltip: {
							start: "点击开始绘制图形",
							cont: "点击继续绘制图形",
							end: "点击最后一个点或者双击结束绘制"
			...
			edit: {
				toolbar: {
					...
					buttons: {
						edit: "编辑图形",
						editDisabled: "没有需要编辑的图形",
						remove: "删除图形",
						removeDisabled: "没有需要删除的图形"
					}
				},
				handlers: {
					edit: {
			...
			_fireCreatedEvent: function(t) {
				if(this.options.showLength) {
					var e = this._getMeasurementString();
					t.length = e
				}
				if(this.options.showArea) {
					var i = L.GeometryUtil.readableArea(this._area, this.options.metric);
					t.area = i
				}
				if(this.options.showRadius) {
					var o = Math.PI * this._radius * this._radius,
						i = L.GeometryUtil.readableArea(o, this.options.metric);
					t.area = i
				}
			...
			addVertex: function(t) {
				...
				return e >= 2 && !this.options.allowIntersection && this._poly.newLatLngIntersects(t) ? void this._showErrorTooltip() : (this._errorShown && this._hideErrorTooltip(), this._markers.push(this._createMarker(t)), this._poly.addLatLng(t), 2 === this._poly.getLatLngs().length && this._map.addLayer(this._poly), void this._vertexChanged(t, !0))
			},
			...
			initialize: function(t, e) {
				L.Draw.Polyline.prototype.initialize.call(this, t, e), this.type = L.Draw.Polygon.TYPE, this.options.showLength = this.options.showArea
			},
			_updateFinishHandler: function() {
				var t = this._markers.length;
			...
			_onMouseUp: function(t) {
				return this._shape || this._isCurrentlyTwoClickDrawing ? void(this._isCurrentlyTwoClickDrawing && !o(t.target, "leaflet-pane") || L.Draw.SimpleShape.prototype._onMouseUp.call(this)) : void(this._isCurrentlyTwoClickDrawing = !0)
			},
			...
			_getTooltipText: function() {
				var t, e, i = L.Draw.SimpleShape.prototype._getTooltipText.call(this),
					o = this._shape,
					a = this.options.showArea;
				return o && (t = this._shape._defaultShape ? this._shape._defaultShape() : this._shape.getLatLngs(), this._area = L.GeometryUtil.geodesicArea(t), e = a ? L.GeometryUtil.readableArea(this._area, this.options.metric) : ""), {
					text: i.text,
					subtext: e
				}
			}
			...
			_onMouseMove: function(t) {
				...
				if(this._tooltip.updatePosition(e), this._isDrawing) {
					this._drawShape(e), this._radius = this._shape.getRadius().toFixed(1);
					var o = "";
					i && (o = L.drawLocal.draw.handlers.circle.radius + ": " + L.GeometryUtil.readableDistance(this._radius, this.options.metric, this.options.feet, this.options.nautic)), this._tooltip.updateContent({
						text: this._endLabelText,
						subtext: o
					})
				}
			...
			_createMiddleMarker: function(t, e) {
				...
				s.setOpacity(.6), t._middleRight = e._middleLeft = s,
					o = function() {
		...
		function() {
			...
			L.GeometryUtil = L.extend(L.GeometryUtil || {}, {
				...
				readableArea: function(e, i, o) {
					...
					return i ? (n = ["km", "m"], type = typeof i, "string" === type ? n = [i] : "boolean" !== type && (n = i), a = e >= 1e6 && n.indexOf("km") !== -1 ? L.GeometryUtil.formattedNumber(1e-6 * e, o.km) + " km²" : e >= 1e4 && n.indexOf("ha") !== -1 ? L.GeometryUtil.formattedNumber(1e-4 * e, o.ha) + " ha" : L.GeometryUtil.formattedNumber(e, o.m) + " m²") : (e /= .836127, a = e >= 3097600 ? L.GeometryUtil.formattedNumber(e / 3097600, o.mi) + " mi²" : e >= 4840 ? L.GeometryUtil.formattedNumber(e / 4840, o.ac) + " acres" : L.GeometryUtil.formattedNumber(e, o.yd) + " yd²"), a
				},
				readableDistance: function(e, i, o, a, n) {
					var s, r, n = L.Util.extend({}, t, n);
					switch(r = i ? "string" == typeof i ? i : "metric" : o ? "feet" : a ? "nauticalMile" : "yards") {
						case "metric":
			...
			intersects: function() {
				var t, e, i, o, a, n = this._getProjectedPoints();
				return !this._tooFewPointsForIntersection() && (!!(t = L.Polyline.prototype.intersects.call(this)) || (e = n.length, i = n[0], o = n[e - 1], a = e - 2, this._lineSegmentsIntersectsRange(o, i, a, 1)))
			}
			...
			initialize: function(t) {
				...
				var e;
				this._toolbars = {}, L.DrawToolbar && this.options.draw && (e = new L.DrawToolbar(this.options.draw, this.options.drawButtons), this._toolbars[L.DrawToolbar.TYPE] = e, this._toolbars[L.DrawToolbar.TYPE].on("enable", this._toolbarEnabled, this)), L.EditToolbar && this.options.edit && (e = new L.EditToolbar(this.options.edit, this.options.editButtons, this.options.actionButtons), this._toolbars[L.EditToolbar.TYPE] = e, this._toolbars[L.EditToolbar.TYPE].on("enable", this._toolbarEnabled, this)), L.toolbar = this
			},
			onAdd: function(t) {
				var e, i = L.DomUtil.create("div", "leaflet-draw"),
					o = !1,
					a = "leaflet-draw-toolbar-top";
				for(var n in this._toolbars) this._toolbars.hasOwnProperty(n) && (e = this._toolbars[n].addToolbar(t), e && (o || (L.DomUtil.hasClass(e, a) || L.DomUtil.addClass(e.childNodes[0], a), o = !0)));
				return i
			},
			onRemove: function() {
			...
			initialize: function(t, e, i) {
				L.setOptions(this, t), this._modes = {}, this._actionButtons = [], this._activeMode = null, this.buttons = e, this.actionButtons = i;
				var o = L.version.split(".");
				1 === parseInt(o[0], 10) && parseInt(o[1], 10) >= 2 ? L.Toolbar.include(L.Evented.prototype) : L.Toolbar.include(L.Mixin.Events)
			},
			enabled: function() {
			...
			addToolbar: function(t) {
				...
				if(this.actionButtons && this._handlerActivated({
						handler: "remove"
					}), o) return this._lastButtonIndex = --o, this._actionsContainer = L.DomUtil.create("ul", "leaflet-draw-actions"), i.appendChild(this._toolbarContainer), i.appendChild(this._actionsContainer), i
			},
			...
			_initModeHandler: function(t, e, i, o, a) {
				var n = t.type;
				this._modes[n] = {}, this._modes[n].handler = t, this.buttons && this.buttons[t.type] ? (this._modes[n].button = this._bindingButton({
					type: n,
					title: a,
					className: o + "-" + n,
					container: e,
					...
					id: this.buttons[t.type]
				}), this._modes[n].handler.on("enabled", this._handlerActivated2, this).on("disabled", this._handlerDeactivated2, this)) : (this._modes[n].button = this._createButton({
					type: n,
					title: a,
					className: o + "-" + n,
					container: e,
			...
			_detectIOS: function() {
				var e = /iPad|iPhone|iPod/.test(navigator.userAgent) && !t.MSStream;
				return e
			},
			...
			_bindingButton: function(t) {
				var e = L.DomUtil.get(t.id);
				if(e) {
					var i = this._detectIOS() ? "touchstart" : "click";
					return L.DomEvent.on(e, "click", L.DomEvent.stopPropagation).on(e, "mousedown", L.DomEvent.stopPropagation).on(e, "dblclick", L.DomEvent.stopPropagation).on(e, "touchstart", L.DomEvent.stopPropagation).on(e, "click", L.DomEvent.preventDefault).on(e, i, t.callback, t.context), e
				}
			},
			...
			_handlerActivated2: function(t) {
				this.disable(), this._activeMode = this._modes[t.handler], this.fire("enable")
			},
			_handlerDeactivated2: function() {
			...
			_createActions: function(t) {
				...
				if(this._actionButtons = [], n)
					for(; n.firstChild;) n.removeChild(n.firstChild);
				for(var l = 0; l < r; l++) "enabled" in s[l] && !s[l].enabled || (e = L.DomUtil.create("li", "", n), a = this.actionButtons ? this._bindingButton({
					title: s[l].title,
					text: s[l].text,
					container: e,
					callback: s[l].callback,
					context: s[l].context,
					id: this.actionButtons[s[l].type]
				}) : this._createButton({
					title: s[l].title,
					text: s[l].text,
					container: e,
			...
			_showActionsToolbar: function() {
				...
				this._createActions(this._activeMode.handler), this._actionsContainer && (this._actionsContainer.style.top = i + "px"), 0 == t && (L.DomUtil.addClass(this._toolbarContainer, "leaflet-draw-toolbar-notop"), L.DomUtil.addClass(this._actionsContainer, "leaflet-draw-actions-top")), t >= 0 && t == e && (L.DomUtil.addClass(this._toolbarContainer, "leaflet-draw-toolbar-nobottom"), L.DomUtil.addClass(this._actionsContainer, "leaflet-draw-actions-bottom")), this._actionsContainer && (this._actionsContainer.style.display = "block"), this._map.fire(L.Draw.Event.TOOLBAROPENED)
			},
			...
			initialize: function(t, e) {
				for(var i in this.options) this.options.hasOwnProperty(i) && t[i] && (t[i] = L.extend({}, this.options[i], t[i]));
				this._toolbarClass = "leaflet-draw-draw", L.Toolbar.prototype.initialize.call(this, t, e)
			},
			...
			_save: function() {
				this._activeMode && this._activeMode.handler.save(), this._activeMode && this._activeMode.handler.disable()
			},
			_clearAllLayers: function() {
				this._activeMode = this._modes.remove, this._activeMode && this._activeMode.handler.removeAllLayers(), this._activeMode && this._activeMode.handler.disable()
			},
			...
			addHooks: function() {
				...
				t && (t.getContainer().focus(), this._featureGroup.eachLayer(this._enableLayerEdit, this), this._tooltip = new L.Draw.Tooltip(this._map), this._tooltip.updateContent({
					...
					this._updateTooltip(), this._map.on("mousemove", this._onMouseMove, this).on("touchmove", this._onMouseMove, this).on("MSPointerMove", this._onMouseMove, this).on(L.Draw.Event.EDITVERTEX, this._updateTooltip, this))
			},
			removeHooks: function() {
			...
			revertLayers: function() {
				this._deletedLayers && this._deletedLayers.eachLayer(function(t) {
			...
			_removeLayer: function(t) {
				var e = t.layer || t.target || t;
				this._deletableLayers.removeLayer(e), this._deletedLayers && this._deletedLayers.addLayer(e), e.fire("deleted")
			},
			_onMouseMove: function(t) {
				this._tooltip.updatePosition(t.latlng)
			},
